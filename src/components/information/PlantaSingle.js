...
export const PlantaSingle = () => {
  ...
  const getPlanta = async () => {
    ...
    const result = await axios.get(
      `https://plantasagrecol.cf/Plantas_medicinale/` + path
    );
  ...
  const Generar_pdf = async () => {
    ...
    doc.text(154, 22, "Fecha: 08-11-22"); //fecha automatica
    ...
    doc.text(80, 155, planta.propiedades, {
      align: "justify",
      lineHeightFactor: 1,
      maxWidth: 110,
    });
    doc.text(80, 195, planta.descripcion, {
      align: "justify",
      lineHeightFactor: 1,
      maxWidth: 110,
    });
    doc.text(80, 235, planta.conocimiento_ancestral, {
      align: "justify",
      lineHeightFactor: 1,
      maxWidth: 110,
    });
  ...
  return (
    <>
      ...
      <div className="planta-container">
        ...
        <div className="container mt-4 mb-4 container-right">
          ...
          <div style={{ display: "flex", marginTop: "2rem" }}>
            <Link to={"/About"}>
              ...
              <button className="btn btn-danger" onClick={Generar_pdf}>
                {" "}
                descargar PDF
              </button>
            </Link>
